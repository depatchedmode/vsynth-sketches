...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 900.0, 141.0, 64.0 ],
					"varname" : "vs_duotoner",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 222.0, 756.0, 215.0, 98.0 ],
					"varname" : "vs_convolve",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "vs_xy_sobel.maxpat",
					"numinlets" : 0,
					"numoutlets" : 3,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 616.0, 211.0, 78.5, 104.5 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 368.0, 488.0, 46.0, 59.0 ],
					"varname" : "vs_inverter",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 221.0, 482.0, 139.0, 71.0 ],
					"varname" : "vs_luma_key",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 425.0, 482.0, 178.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 221.0, 335.0, 178.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 221.0, 435.5, 88.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 221.0, 235.5, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 316.0, 101.0, 178.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 221.0, 204.333333333333258, 95.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 316.0, 235.5, 139.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 802.5, 530.0, 106.0, 63.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 221.0, 101.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 221.0, 40.0, 62.0, 40.0 ],
					"varname" : "vs_noise_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 222.0, 996.0, 63.0, 22.0 ],
					"text" : "s final-mix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1005.0, 211.0, 65.0, 22.0 ],
					"text" : "pak size i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1036.0, 167.0, 29.5, 22.0 ],
					"text" : "* 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1036.0, 131.0, 32.0, 22.0 ],
					"text" : "/ 16."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 962.5, 108.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 925.0, 194.0, 63.0, 22.0 ],
					"text" : "pak dim i i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 876.5, 108.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 816.0, 649.333333333333258, 189.0, 35.0 ],
					"text" : "name Scene1, read 2020-12-21 - Solstris.json, 1"
				}

			}
, 			{
				"box" : 				{
					"autorestore" : "2020-12-21 - Solstris.json",
					"id" : "obj-3",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 816.0, 619.333333333333258, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 867.5, 150.0, 41.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 325.5, 324.0, 411.0, 324.0, 411.0, 412.0, 299.5, 412.0 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 325.5, 324.0, 411.0, 324.0, 411.0, 412.0, 253.5, 412.0 ],
					"order" : 1,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 230.5, 423.0, 276.5, 423.0 ],
					"order" : 0,
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 230.5, 414.0, 230.5, 414.0 ],
					"order" : 1,
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 230.5, 569.0, 421.0, 569.0, 421.0, 472.0, 434.5, 472.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 230.5, 183.0, 312.0, 183.0, 312.0, 96.0, 325.5, 96.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-19::obj-43" : [ "temp_freq[1]", "Cutoff", 0 ],
			...
			"obj-20::obj-1" : [ "comparator_rgb", "live.text", 0 ],
			"obj-20::obj-20" : [ "comparator_thrshld[1]", "Threshold", 0 ],
			"obj-20::obj-25" : [ "comparator_smth[1]", "Smooth", 0 ],
			"obj-25::obj-19" : [ "offrot_angle", "Angle", 0 ],
			"obj-25::obj-35" : [ "offrot_zoom", "Zoom", 0 ],
			"obj-25::obj-4" : [ "MENU[1]", "angle", 0 ],
			"obj-25::obj-6" : [ "offrot_x", "X", 0 ],
			"obj-25::obj-67" : [ "MENU", "angle", 0 ],
			"obj-25::obj-8" : [ "offrot_y", "Y", 0 ],
			"obj-25::obj-9" : [ "MENU[2]", "angle", 0 ],
			...
			"obj-31::obj-4" : [ "MENU[5]", "angle", 0 ],
			"obj-31::obj-6" : [ "offrot_x[1]", "X", 0 ],
			"obj-31::obj-67" : [ "MENU[6]", "angle", 0 ],
			"obj-31::obj-8" : [ "offrot_y[1]", "Y", 0 ],
			"obj-31::obj-9" : [ "MENU[3]", "angle", 0 ],
			"obj-31::obj-96" : [ "offrot_boundmode[1]", "live.menu", 0 ],
			"obj-32::obj-19" : [ "offrot_angle[2]", "Angle", 0 ],
			"obj-32::obj-35" : [ "offrot_zoom[2]", "Zoom", 0 ],
			"obj-32::obj-4" : [ "MENU[9]", "angle", 0 ],
			"obj-32::obj-6" : [ "offrot_x[2]", "X", 0 ],
			"obj-32::obj-67" : [ "MENU[7]", "angle", 0 ],
			"obj-32::obj-8" : [ "offrot_y[2]", "Y", 0 ],
			"obj-32::obj-9" : [ "MENU[8]", "angle", 0 ],
			"obj-32::obj-96" : [ "offrot_boundmode[2]", "live.menu", 0 ],
			"obj-33::obj-20" : [ "luma_invert", "live.text", 0 ],
			"obj-33::obj-21" : [ "luma_smth", "Smooth", 0 ],
			"obj-33::obj-3" : [ "luma_thrshld", "Threshold", 0 ],
			"obj-35::obj-1" : [ "ineverter_inv", "INVERT", 0 ],
			"obj-39::obj-19" : [ "vs_phase_ctrl", "vs_phase_ctrl", 0 ],
			"obj-40::obj-19" : [ "r01", "live.numbox", 0 ],
			"obj-40::obj-22" : [ "r02", "live.numbox", 0 ],
			"obj-40::obj-23" : [ "r12", "live.numbox", 0 ],
			"obj-40::obj-24" : [ "r11", "live.numbox", 0 ],
			"obj-40::obj-25" : [ "r10", "live.numbox", 0 ],
			"obj-40::obj-26" : [ "r22", "live.numbox", 0 ],
			"obj-40::obj-27" : [ "r21", "live.numbox", 0 ],
			"obj-40::obj-28" : [ "r20", "live.numbox", 0 ],
			"obj-40::obj-5" : [ "r00", "live.numbox", 0 ],
			"obj-40::obj-54" : [ "width", "Width", 0 ],
			"obj-40::obj-7" : [ "kernel", "kernel", 0 ],
			"obj-44::obj-15" : [ "bc1", "live.text[6]", 0 ],
			"obj-44::obj-24" : [ "duo_c1", "swatch", 0 ],
			"obj-44::obj-27" : [ "duo_mode", "live.text[6]", 0 ],
			"obj-44::obj-28" : [ "duo_threshold", "Threshold", 0 ],
			"obj-44::obj-29" : [ "duo_smooth", "Smooth", 0 ],
			"obj-44::obj-37" : [ "duo_c2", "swatch", 0 ],
			"obj-44::obj-4" : [ "bc2", "live.text", 0 ],
			...
			"obj-8::obj-2" : [ "vs_audio2video_mode", "dim_x", 0 ],
			"obj-8::obj-7" : [ "noise2_interp", "filter", 0 ],
			"parameterbanks" : 			{
