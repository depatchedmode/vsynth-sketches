...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 848.0, 103.0, 220.0, 134.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 372.0, 747.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 498.0, 745.0, 215.0, 98.0 ],
					"varname" : "vs_convolve",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 198.0, 747.0, 115.0, 94.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 644.0, 103.0, 178.0, 132.0 ],
					"varname" : "vs_wfg_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 490.0, 200.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 490.0, 232.0, 73.0, 22.0 ],
					"text" : "prepend pm"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 314.0, 622.5, 75.0, 73.5 ],
					"varname" : "vs_lfo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 198.0, 625.0, 97.0, 71.0 ],
					"varname" : "vs_vca",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 181.25, 143.06883773913043, 59.5 ],
					"varname" : "vs_sync",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.0, 200.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 232.0, 77.0, 22.0 ],
					"text" : "prepend freq"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 390.0, 409.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 494.0, 281.0, 277.0, 100.0 ],
					"varname" : "vs_wfg_2[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 198.0, 505.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "2021-02-04 - The Crossing.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 198.0, 281.0, 277.0, 100.0 ],
					"varname" : "vs_wfg_2[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 199.0, 890.0, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 198.0, 407.0, 122.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 16.0, 259.0, 79.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-18::obj-21" : [ "vca_am", "AM", 0 ],
			"obj-18::obj-4" : [ "vca_bias", "Bias", 0 ],
			...
			"obj-28::obj-10" : [ "wfg3_bias", "Bias", 0 ],
			"obj-28::obj-14" : [ "wfg3_biasm", "BM", 0 ],
			"obj-28::obj-17" : [ "live.menu[19]", "live.menu", 0 ],
			"obj-28::obj-22" : [ "live.toggle[8]", "live.toggle[1]", 0 ],
			"obj-28::obj-24" : [ "live.toggle", "live.toggle", 0 ],
			"obj-28::obj-29" : [ "wfg3_freq", "Freq", 0 ],
			"obj-28::obj-30" : [ "wfg3_angle", "Angle", 0 ],
			"obj-28::obj-4" : [ "wfg3_fm", "FM", 0 ],
			"obj-28::obj-42" : [ "live.toggle[6]", "live.toggle", 0 ],
			"obj-28::obj-53" : [ "wfg3_speed", "Speed", 0 ],
			"obj-28::obj-6" : [ "wfg3_pm", "PM", 0 ],
			"obj-28::obj-65" : [ "wfg3_shape", "Shape", 0 ],
			"obj-2::obj-15" : [ "live.menu[1]", "live.menu", 0 ],
			"obj-2::obj-23" : [ "live.menu[16]", "live.menu", 0 ],
			"obj-2::obj-27" : [ "hslm_sm", "SM", 0 ],
			"obj-2::obj-28" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-2::obj-33" : [ "live.menu[17]", "live.menu", 0 ],
			"obj-2::obj-39" : [ "hslm_hm", "HM", 0 ],
			"obj-2::obj-46" : [ "hslm_hue", "Hue", 0 ],
			"obj-2::obj-47" : [ "hslm_lm", "LM", 0 ],
			"obj-2::obj-48" : [ "hslm_sat", "Sat", 0 ],
			"obj-2::obj-49" : [ "hslm_light", "Light", 0 ],
			"obj-2::obj-53" : [ "hslm_pedestal", "Pedestal", 0 ],
			...
			"obj-37::obj-43" : [ "temp_freq[1]", "Cutoff", 0 ],
			"obj-38::obj-10" : [ "bias", "Bias", 0 ],
			"obj-38::obj-14" : [ "bm", "BM", 0 ],
			"obj-38::obj-17" : [ "live.menu[22]", "live.menu", 0 ],
			"obj-38::obj-22" : [ "live.text", "live.text", 0 ],
			"obj-38::obj-29" : [ "freq", "Freq", 0 ],
			"obj-38::obj-30" : [ "angle", "Angle", 0 ],
			"obj-38::obj-42" : [ "live.toggle[7]", "live.toggle", 0 ],
			"obj-38::obj-47" : [ "polarizer", "Morph", 0 ],
			"obj-38::obj-51" : [ "live.menu[21]", "live.menu", 0 ],
			"obj-38::obj-53" : [ "speed", "Speed", 0 ],
			"obj-38::obj-54" : [ "morph", "Morph", 0 ],
			"obj-38::obj-6" : [ "pm", "PM", 0 ],
			"obj-38::obj-65" : [ "shape", "Shape", 0 ],
			...
			"obj-5::obj-139" : [ "wfg2_sync_lock", "wfg2_sync_lock", 0 ],
			"obj-5::obj-23" : [ "wfg2_pwm", "PWM", 0 ],
			"obj-5::obj-24" : [ "wfg2_pw", "PW", 0 ],
			"obj-5::obj-25" : [ "wfg2_fm", "FM", 0 ],
			"obj-5::obj-26" : [ "wfg2_freq", "Freq", 0 ],
			"obj-5::obj-27" : [ "wfg2_wf", "wfg2_wf", 0 ],
			"obj-5::obj-28" : [ "live.toggle[5]", "live.toggle[1]", 0 ],
...
,
				"obj-5::obj-10" : 				{
					"parameter_longname" : "Master Freq",
					"parameter_range" : [ -1.0, 1.0 ],
					"parameter_shortname" : "Master Freq"
				}
,
				"obj-5::obj-13" : 				{
