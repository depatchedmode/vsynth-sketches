...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 349.0, 830.0, 164.0, 17.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 22.0, 791.0, 139.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 32.0, 513.0, 215.0, 98.0 ],
					"varname" : "vs_convolve",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 290.0, 543.0, 46.0, 59.0 ],
					"varname" : "vs_inverter",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 345.0, 505.0, 148.0, 71.0 ],
					"varname" : "vs_edges",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 345.0, 589.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 159.0, 617.0, 139.0, 71.0 ],
					"varname" : "vs_luma_key",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 25.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 58.0, 77.0, 22.0 ],
					"text" : "prepend freq"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 101.0, 12.0, 75.0, 73.5 ],
					"varname" : "vs_lfo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 578.0, 206.0, 178.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 262.0, 245.0, 178.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 517.0, 505.0, 178.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 517.0, 409.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 622.5, 252.0, 220.0, 134.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 548.0, 97.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 461.0, 257.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 159.0, 97.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 159.0, 380.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "2021-01-16 - Robot Catfish.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 858.0, 554.0, 135.0, 22.0 ],
					"priority" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 875.0, 554.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 858.0, 433.5, 171.0, 115.0 ],
					"varname" : "vs_presets",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 759.0, 433.5, 95.0, 142.5 ],
					"varname" : "vs_render",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 159.0, 883.0, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-12::obj-43" : [ "temp_freq[1]", "Cutoff", 0 ],
			...
			"obj-14::obj-19" : [ "offrot_angle[1]", "Angle", 0 ],
			"obj-14::obj-35" : [ "offrot_zoom[1]", "Zoom", 0 ],
			"obj-14::obj-4" : [ "MENU[4]", "angle", 0 ],
			"obj-14::obj-6" : [ "offrot_x[1]", "X", 0 ],
			"obj-14::obj-67" : [ "MENU[5]", "angle", 0 ],
			"obj-14::obj-8" : [ "offrot_y[1]", "Y", 0 ],
			"obj-14::obj-9" : [ "MENU[3]", "angle", 0 ],
			"obj-14::obj-96" : [ "offrot_boundmode[1]", "live.menu", 0 ],
			"obj-15::obj-19" : [ "offrot_angle[2]", "Angle", 0 ],
			"obj-15::obj-35" : [ "offrot_zoom[2]", "Zoom", 0 ],
			"obj-15::obj-4" : [ "MENU[7]", "angle", 0 ],
			"obj-15::obj-6" : [ "offrot_x[2]", "X", 0 ],
			"obj-15::obj-67" : [ "MENU[8]", "angle", 0 ],
			"obj-15::obj-8" : [ "offrot_y[2]", "Y", 0 ],
			"obj-15::obj-9" : [ "MENU[6]", "angle", 0 ],
			"obj-15::obj-96" : [ "offrot_boundmode[2]", "live.menu", 0 ],
			...
			"obj-21::obj-29" : [ "edges_thrshld", "Threshold", 0 ],
			"obj-21::obj-3" : [ "edges_mode", "live.text", 0 ],
			"obj-21::obj-30" : [ "edges_smth", "Smooth", 0 ],
			"obj-21::obj-51" : [ "edges_freq", "Cutoff", 0 ],
			"obj-22::obj-1" : [ "ineverter_inv", "INVERT", 0 ],
			"obj-23::obj-19" : [ "r01", "live.numbox", 0 ],
			"obj-23::obj-22" : [ "r02", "live.numbox", 0 ],
			"obj-23::obj-23" : [ "r12", "live.numbox", 0 ],
			"obj-23::obj-24" : [ "r11", "live.numbox", 0 ],
			"obj-23::obj-25" : [ "r10", "live.numbox", 0 ],
			"obj-23::obj-26" : [ "r22", "live.numbox", 0 ],
			"obj-23::obj-27" : [ "r21", "live.numbox", 0 ],
			"obj-23::obj-28" : [ "r20", "live.numbox", 0 ],
			"obj-23::obj-5" : [ "r00", "live.numbox", 0 ],
			"obj-23::obj-54" : [ "width", "Width", 0 ],
			"obj-23::obj-7" : [ "kernel", "kernel", 0 ],
			...
			"obj-8::obj-13" : [ "shapewfg_dir[2]", "inevrt", 0 ],
			"obj-8::obj-130" : [ "shapewfg_time[2]", "Time", 0 ],
			"obj-8::obj-137" : [ "shapewfg_shape[2]", "shape", 0 ],
			"obj-8::obj-26" : [ "shapewfg_pwm[2]", "PWM", 0 ],
			"obj-8::obj-27" : [ "shapewfg_pw[2]", "PW", 0 ],
			"obj-8::obj-30" : [ "shapewfg_fm[2]", "PM", 0 ],
			"obj-8::obj-32" : [ "shapewfg_fm_range[2]", "scale_freq_fm", 0 ],
			"obj-8::obj-35" : [ "shapewfg_freq_range[2]", "scale_freq", 0 ],
			"obj-8::obj-36" : [ "shapewfg_freq[2]", "Freq", 0 ],
			"obj-8::obj-37" : [ "shapewfg_wf[2]", "waveform", 0 ],
			"obj-8::obj-45" : [ "shapewfg_polygons[2]", "Vertex", 0 ],
			"obj-9::obj-10" : [ "bias", "Bias", 0 ],
			"obj-9::obj-14" : [ "bm", "BM", 0 ],
			"obj-9::obj-17" : [ "live.menu[18]", "live.menu", 0 ],
			"obj-9::obj-22" : [ "live.text", "live.text", 0 ],
			"obj-9::obj-29" : [ "freq", "Freq", 0 ],
			"obj-9::obj-30" : [ "angle", "Angle", 0 ],
			"obj-9::obj-42" : [ "live.toggle[2]", "live.toggle", 0 ],
			"obj-9::obj-47" : [ "polarizer", "Morph", 0 ],
			"obj-9::obj-51" : [ "live.menu[17]", "live.menu", 0 ],
...
, 			{
				"name" : "2021-01-16 - Robot Catfish.json",
...
, 			{
				"name" : "vs_shapes_saw_square.genjit",
