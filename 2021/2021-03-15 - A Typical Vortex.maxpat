...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 295.0, 825.0, 164.0, 17.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 169.0, 587.0, 215.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 108.0, 741.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 413.0, 684.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 108.0, 504.0, 121.06883773913043, 72.5 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 608.5, 563.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 439.5, 539.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 237.0, 169.5, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 413.0, 373.0, 215.0, 98.0 ],
					"varname" : "vs_convolve",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 539.0, 212.0, 41.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 237.0, 253.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 9.0, 200.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 165.0, 72.0, 22.0 ],
					"text" : "prepend fps"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 145.5, 135.0, 22.0 ],
					"priority" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 125.0, 145.5, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 8.0, 200.0, 133.0 ],
					"varname" : "vs_presets",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 108.0, 373.0, 277.0, 100.0 ],
					"varname" : "vs_wfg_2[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 8.0, 95.0, 142.5 ],
					"varname" : "vs_render",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 106.0, 829.0, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 9.0, 265.0, 79.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-17::obj-19" : [ "r01", "live.numbox", 0 ],
			"obj-17::obj-22" : [ "r02", "live.numbox", 0 ],
			"obj-17::obj-23" : [ "r12", "live.numbox", 0 ],
			"obj-17::obj-24" : [ "r11", "live.numbox", 0 ],
			"obj-17::obj-25" : [ "r10", "live.numbox", 0 ],
			"obj-17::obj-26" : [ "r22", "live.numbox", 0 ],
			"obj-17::obj-27" : [ "r21", "live.numbox", 0 ],
			"obj-17::obj-28" : [ "r20", "live.numbox", 0 ],
			"obj-17::obj-5" : [ "r00", "live.numbox", 0 ],
			"obj-17::obj-54" : [ "width", "Width", 0 ],
			"obj-17::obj-7" : [ "kernel", "kernel", 0 ],
			...
			"obj-23::obj-31" : [ "clrizer_hue[3]", "Hue", 0 ],
			"obj-23::obj-60" : [ "clrizer_color[3]", "color", 0 ],
			"obj-25::obj-43" : [ "temp_freq[2]", "Cutoff", 0 ],
			...
			"obj-26::obj-33" : [ "live.menu[16]", "live.menu", 0 ],
