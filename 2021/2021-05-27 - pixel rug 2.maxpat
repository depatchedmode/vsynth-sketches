...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 929.0, 660.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 529.0, 802.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 735.0, 1033.0, 164.0, 17.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 529.0, 907.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 278.0, 532.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 529.0, 716.0, 88.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 529.0, 602.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 529.0, 363.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 529.0, 497.0, 121.06883773913043, 72.5 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 126.0, 43.0, 268.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 529.0, 756.0, 61.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 529.0, 245.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 529.0, 179.0, 133.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 699.0, 152.5, 45.0, 45.0 ]
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 529.0, 125.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					"autorestore" : "2021-05-27 - pixel rug 2.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 529.0, 1044.75, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-48::obj-15" : [ "live.menu[1]", "live.menu", 0 ],
			"obj-48::obj-23" : [ "live.menu[12]", "live.menu", 0 ],
			"obj-48::obj-27" : [ "colorizer_2_sat_mod", "SM", 0 ],
			"obj-48::obj-28" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-48::obj-33" : [ "live.menu[3]", "live.menu", 0 ],
			"obj-48::obj-39" : [ "colorizer_2_hue_mod", "HM", 0 ],
			"obj-48::obj-46" : [ "colorizer_2_hue", "Hue", 0 ],
			"obj-48::obj-48" : [ "colorizer_2_saturation", "Sat", 0 ],
			"obj-48::obj-49" : [ "colorizer_2_light", "Light", 0 ],
			"obj-48::obj-53" : [ "colorizer_2_pedestal", "Pedestal", 0 ],
...
, 			{
				"name" : "2021-05-27 - pixel rug.json",
