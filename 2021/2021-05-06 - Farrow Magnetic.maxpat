...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 356.5, 868.75, 164.0, 17.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 566.0, 215.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 761.0, 476.0, 84.0, 22.0 ],
					"text" : "prepend ydisp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 751.0, 445.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 682.0, 418.0, 94.0, 22.0 ],
					"text" : "scale 0. 1. -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 628.0, 455.0, 84.0, 22.0 ],
					"text" : "prepend xdisp"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 640.0, 327.75, 75.0, 73.5 ],
					"varname" : "vs_lfo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 407.0, 647.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 188.0, 739.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 557.0, 784.75, 215.0, 98.0 ],
					"varname" : "vs_convolve",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 557.0, 697.0, 143.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 333.0, 258.75, 268.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 333.0, 374.0, 178.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 557.0, 593.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 557.0, 500.0, 226.0, 82.0 ],
					"varname" : "vs_xyz_disp",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 333.0, 500.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 333.0, 126.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "2021-05-06 - Farrow Magnetic.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 188.0, 867.75, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-12::obj-23" : [ "live.menu[12]", "live.menu", 0 ],
			"obj-12::obj-27" : [ "colorizer_2_sat_mod", "SM", 0 ],
			"obj-12::obj-28" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-12::obj-33" : [ "live.menu[3]", "live.menu", 0 ],
			"obj-12::obj-39" : [ "colorizer_2_hue_mod", "HM", 0 ],
			"obj-12::obj-46" : [ "colorizer_2_hue", "Hue", 0 ],
			"obj-12::obj-48" : [ "colorizer_2_saturation", "Sat", 0 ],
			"obj-12::obj-49" : [ "colorizer_2_light", "Light", 0 ],
			"obj-12::obj-53" : [ "colorizer_2_pedestal", "Pedestal", 0 ],
			"obj-13::obj-19" : [ "r01[1]", "live.numbox", 0 ],
			"obj-13::obj-22" : [ "r02[1]", "live.numbox", 0 ],
			"obj-13::obj-23" : [ "r12[1]", "live.numbox", 0 ],
			"obj-13::obj-24" : [ "r11[1]", "live.numbox", 0 ],
			"obj-13::obj-25" : [ "r10[1]", "live.numbox", 0 ],
			"obj-13::obj-26" : [ "r22[1]", "live.numbox", 0 ],
			"obj-13::obj-27" : [ "r21[1]", "live.numbox", 0 ],
			"obj-13::obj-28" : [ "r20[1]", "live.numbox", 0 ],
			"obj-13::obj-5" : [ "r00[1]", "live.numbox", 0 ],
			"obj-13::obj-54" : [ "width[1]", "Width", 0 ],
			"obj-13::obj-7" : [ "kernel[1]", "kernel", 0 ],
			...
			"obj-15::obj-19" : [ "r01", "live.numbox", 0 ],
			"obj-15::obj-22" : [ "r02", "live.numbox", 0 ],
			"obj-15::obj-23" : [ "r12", "live.numbox", 0 ],
			"obj-15::obj-24" : [ "r11", "live.numbox", 0 ],
			"obj-15::obj-25" : [ "r10", "live.numbox", 0 ],
			"obj-15::obj-26" : [ "r22", "live.numbox", 0 ],
			"obj-15::obj-27" : [ "r21", "live.numbox", 0 ],
			"obj-15::obj-28" : [ "r20", "live.numbox", 0 ],
			"obj-15::obj-5" : [ "r00", "live.numbox", 0 ],
			"obj-15::obj-54" : [ "width", "Width", 0 ],
			"obj-15::obj-7" : [ "kernel", "kernel", 0 ],
			"obj-16::obj-15" : [ "live.menu[37]", "live.menu", 0 ],
			"obj-16::obj-23" : [ "live.menu[39]", "live.menu", 0 ],
			"obj-16::obj-27" : [ "hslm_sm", "SM", 0 ],
			"obj-16::obj-28" : [ "live.menu[36]", "live.menu", 0 ],
			"obj-16::obj-33" : [ "live.menu[38]", "live.menu", 0 ],
			...
			"obj-17::obj-43" : [ "temp_freq[1]", "Cutoff", 0 ],
			...
			"obj-6::obj-22::obj-29" : [ "live.numbox[1]", "live.numbox", 0 ],
			...
			"obj-9::obj-4" : [ "MENU[5]", "angle", 0 ],
			"obj-9::obj-6" : [ "offrot_x[1]", "X", 0 ],
			"obj-9::obj-67" : [ "MENU", "angle", 0 ],
			"obj-9::obj-8" : [ "offrot_y", "Y", 0 ],
			"obj-9::obj-9" : [ "MENU[6]", "angle", 0 ],
...
, 			{
				"name" : "2021-05-06 - Farrow Magnetic.json",
