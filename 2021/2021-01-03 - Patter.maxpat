...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 666.0, 684.833327412605286, 143.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 388.465581130434771, 815.0, 215.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 648.465581130434771, 842.0, 139.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 100.465581130434771, 763.0, 215.0, 98.0 ],
					"varname" : "vs_convolve",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 100.465581130434771, 616.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 100.465581130434771, 876.333327412605286, 139.0, 71.0 ],
					"varname" : "vs_luma_key",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 366.465581130434771, 724.0, 178.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 366.465581130434771, 573.333327412605286, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 366.465581130434771, 504.0, 62.0, 38.0 ],
					"varname" : "vs_fish_eye",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 366.465581130434771, 376.0, 215.0, 100.0 ],
					"varname" : "vs_wfg_rad",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 112.0, 211.25, 178.0, 132.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 366.465581130434771, 211.25, 178.0, 132.0 ],
					"varname" : "vs_wfg_3[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 931.0, 396.0, 125.0, 60.0 ],
					"varname" : "vs_capture",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.465581130434771, 944.333327412605286, 63.0, 22.0 ],
					"text" : "s final-mix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1077.0, 417.333332180976868, 164.0, 17.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 378.0, 61.0, 22.0 ],
					"text" : "r final-mix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1229.0, 175.25, 65.0, 22.0 ],
					"text" : "pak size i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1252.0, 141.25, 29.5, 22.0 ],
					"text" : "* 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1252.0, 105.25, 32.0, 22.0 ],
					"text" : "/ 16."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1178.5, 82.25, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1134.5, 168.25, 63.0, 22.0 ],
					"text" : "pak dim i i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1077.0, 120.25, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 504.0, 189.0, 35.0 ],
					"text" : "name Scene1, read 2021-01-02 - Patter.json, 1"
				}

			}
, 			{
				"box" : 				{
					"autorestore" : "2021-01-03 - Patter.json",
					"id" : "obj-3",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 670.333327412605286, 135.0, 22.0 ],
					"priority" : 					{
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 543.333327412605286, 171.0, 115.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1077.0, 476.666660745938543, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 168.25, 41.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 20.0, 16.0, 80.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 220.75, 95.0, 142.5 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1151.0, 378.0, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-10::obj-10" : [ "bi_wfg_bias", "Bias", 0 ],
			"obj-10::obj-14" : [ "bi_wfg_bm", "BM", 0 ],
			"obj-10::obj-17" : [ "live.menu[21]", "live.menu", 0 ],
			"obj-10::obj-22" : [ "live.toggle[1]", "live.toggle[1]", 0 ],
			"obj-10::obj-24" : [ "live.toggle", "live.toggle", 0 ],
			"obj-10::obj-29" : [ "bi_wfg_freq", "Freq", 0 ],
			"obj-10::obj-30" : [ "bi_wfg_angle", "Angle", 0 ],
			"obj-10::obj-4" : [ "bi_wfg_fm", "FM", 0 ],
			"obj-10::obj-41" : [ "bi_wfg_mode", "bipolarCol", 0 ],
			"obj-10::obj-42" : [ "live.toggle[2]", "live.toggle", 0 ],
			"obj-10::obj-53" : [ "bi_wfg_speed", "Speed", 0 ],
			"obj-10::obj-6" : [ "bi_wfg_pm", "PM", 0 ],
			"obj-10::obj-65" : [ "bi_wfg_shape", "Shape", 0 ],
			...
			"obj-15::obj-11" : [ "pixelador_dim", "pixelador_dim", 0 ],
			...
			"obj-22::obj-4" : [ "MENU[23]", "angle", 0 ],
			"obj-22::obj-6" : [ "offrot_x[1]", "X", 0 ],
			"obj-22::obj-67" : [ "MENU", "angle", 0 ],
			"obj-22::obj-8" : [ "offrot_y", "Y", 0 ],
			"obj-22::obj-9" : [ "MENU[15]", "angle", 0 ],
			...
			"obj-25::obj-22::obj-19" : [ "displacement_angle[1]", "Angle", 0 ],
			"obj-25::obj-22::obj-29" : [ "live.numbox[3]", "live.numbox", 0 ],
			"obj-25::obj-22::obj-35" : [ "displacement_zoom[1]", "Zoom", 0 ],
			"obj-25::obj-22::obj-4" : [ "disp_ang_range[1]", "angle", 0 ],
			"obj-25::obj-22::obj-40" : [ "displacement_y_m[1]", "YM", 0 ],
			"obj-25::obj-22::obj-42" : [ "displacement_x_m[1]", "XM", 0 ],
			"obj-25::obj-22::obj-44" : [ "displacement_zoom_m[1]", "ZM", 0 ],
			"obj-25::obj-22::obj-47" : [ "displacement_angle_m[1]", "AGLM", 0 ],
			"obj-25::obj-22::obj-52" : [ "MENU[27]", "angle", 0 ],
			"obj-25::obj-22::obj-55" : [ "MENU[26]", "angle", 0 ],
			"obj-25::obj-22::obj-56" : [ "MENU[29]", "angle", 0 ],
			"obj-25::obj-22::obj-57" : [ "MENU[28]", "angle", 0 ],
			"obj-25::obj-22::obj-6" : [ "offrot_x[3]", "X", 0 ],
			"obj-25::obj-22::obj-67" : [ "menu[1]", "angle", 0 ],
			"obj-25::obj-22::obj-8" : [ "displacement_y[1]", "Y", 0 ],
			"obj-25::obj-33" : [ "displacement_init_point[1]", "live.text", 2 ],
			"obj-25::obj-8" : [ "displacement_polar[1]", "live.text", 2 ],
			"obj-25::obj-96" : [ "displacement_boundmode[1]", "live.menu", 0 ],
			...
			"obj-27::obj-20" : [ "luma_invert[5]", "live.text", 0 ],
			"obj-27::obj-21" : [ "luma_smth[5]", "Smooth", 0 ],
			"obj-27::obj-3" : [ "luma_thrshld[5]", "Threshold", 0 ],
			...
			"obj-29::obj-10" : [ "fd_mix", "Mix", 0 ],
			"obj-29::obj-15" : [ "fd_fdbck", "Feedback", 0 ],
			"obj-29::obj-24" : [ "fd_time", "D_Time", 0 ],
			"obj-29::obj-35" : [ "fs_playback", "vs_delay_playback", 0 ],
			"obj-5::obj-10" : [ "vs_preset_name", "vs_preset_name", 0 ],
			"obj-5::obj-15" : [ "live.tab", "live.tab", 0 ],
			"obj-5::obj-32" : [ "live.numbox", "live.numbox", 0 ],
			"obj-8::obj-12" : [ "live.text[2]", "live.text", 0 ],
			"obj-8::obj-15" : [ "live.menu[18]", "live.menu", 0 ],
			"obj-8::obj-19" : [ "live.numbox[1]", "live.numbox", 0 ],
			"obj-9::obj-10" : [ "wfg3_bias[1]", "Bias", 0 ],
			"obj-9::obj-14" : [ "wfg3_biasm[1]", "BM", 0 ],
			"obj-9::obj-17" : [ "live.menu[22]", "live.menu", 0 ],
			"obj-9::obj-22" : [ "live.toggle[5]", "live.toggle[1]", 0 ],
			"obj-9::obj-24" : [ "live.toggle[3]", "live.toggle", 0 ],
			"obj-9::obj-29" : [ "wfg3_freq[1]", "Freq", 0 ],
			"obj-9::obj-30" : [ "wfg3_angle[1]", "Angle", 0 ],
			"obj-9::obj-4" : [ "wfg3_fm[1]", "FM", 0 ],
			"obj-9::obj-42" : [ "live.toggle[4]", "live.toggle", 0 ],
			"obj-9::obj-53" : [ "wfg3_speed[1]", "Speed", 0 ],
			"obj-9::obj-6" : [ "wfg3_pm[1]", "PM", 0 ],
			"obj-9::obj-65" : [ "wfg3_shape[1]", "Shape", 0 ],
			"parameterbanks" : 			{
