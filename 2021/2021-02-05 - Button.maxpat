...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 727.0, 565.5, 139.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 899.0, 456.0, 215.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 378.0, 29.25, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 228.0, 305.0, 75.0, 73.5 ],
					"varname" : "vs_lfo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 663.0, 442.0, 139.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 389.0, 628.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 389.0, 516.0, 215.0, 98.0 ],
					"varname" : "vs_convolve",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 389.0, 420.0, 61.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 216.0, 516.0, 139.0, 71.0 ],
					"varname" : "vs_luma_key",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 210.0, 618.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 216.0, 420.0, 61.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 664.0, 330.0, 136.0, 59.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 362.0, 191.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 722.5, 191.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "2021-02-05 - Button.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.0, 128.5, 135.0, 22.0 ],
					"priority" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 136.0, 128.5, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.0, 8.0, 171.0, 115.0 ],
					"varname" : "vs_presets",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 8.0, 95.0, 142.5 ],
					"varname" : "vs_render",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 683.0, 689.5, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 10.0, 165.0, 79.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-16::obj-13" : [ "shapewfg_dir[1]", "inevrt", 0 ],
			"obj-16::obj-130" : [ "shapewfg_time[1]", "Time", 0 ],
			"obj-16::obj-137" : [ "shapewfg_shape[1]", "shape", 0 ],
			"obj-16::obj-26" : [ "shapewfg_pwm[1]", "PWM", 0 ],
			"obj-16::obj-27" : [ "shapewfg_pw[1]", "PW", 0 ],
			"obj-16::obj-30" : [ "shapewfg_fm[1]", "PM", 0 ],
			"obj-16::obj-32" : [ "shapewfg_fm_range[1]", "scale_freq_fm", 0 ],
			"obj-16::obj-35" : [ "shapewfg_freq_range[1]", "scale_freq", 0 ],
			"obj-16::obj-36" : [ "shapewfg_freq[1]", "Freq", 0 ],
			"obj-16::obj-37" : [ "shapewfg_wf[1]", "waveform", 0 ],
			"obj-16::obj-45" : [ "shapewfg_polygons[1]", "Vertex", 0 ],
			"obj-17::obj-27" : [ "ab2_mode", "ab2_mode", 0 ],
			"obj-17::obj-28" : [ "ab2_threshold", "Threshold", 0 ],
			"obj-17::obj-29" : [ "ab2_smooth", "Smooth", 0 ],
			...
			"obj-21::obj-20" : [ "luma_invert", "live.text", 0 ],
			"obj-21::obj-21" : [ "luma_smth", "Smooth", 0 ],
			"obj-21::obj-3" : [ "luma_thrshld", "Threshold", 0 ],
			"obj-22::obj-51" : [ "lpf_freq[1]", "Cutoff", 0 ],
			...
			"obj-27::obj-13" : [ "shapewfg_dir[2]", "inevrt", 0 ],
			"obj-27::obj-130" : [ "shapewfg_time[2]", "Time", 0 ],
			"obj-27::obj-137" : [ "shapewfg_shape[2]", "shape", 0 ],
			"obj-27::obj-26" : [ "shapewfg_pwm[2]", "PWM", 0 ],
			"obj-27::obj-27" : [ "shapewfg_pw[2]", "PW", 0 ],
			"obj-27::obj-30" : [ "shapewfg_fm[2]", "PM", 0 ],
			"obj-27::obj-32" : [ "shapewfg_fm_range[2]", "scale_freq_fm", 0 ],
			"obj-27::obj-35" : [ "shapewfg_freq_range[2]", "scale_freq", 0 ],
			"obj-27::obj-36" : [ "shapewfg_freq[2]", "Freq", 0 ],
			"obj-27::obj-37" : [ "shapewfg_wf[2]", "waveform", 0 ],
			"obj-27::obj-45" : [ "shapewfg_polygons[2]", "Vertex", 0 ],
			"obj-28::obj-19" : [ "r01[1]", "live.numbox", 0 ],
			"obj-28::obj-22" : [ "r02[1]", "live.numbox", 0 ],
			"obj-28::obj-23" : [ "r12[1]", "live.numbox", 0 ],
			"obj-28::obj-24" : [ "r11[1]", "live.numbox", 0 ],
			"obj-28::obj-25" : [ "r10[1]", "live.numbox", 0 ],
			"obj-28::obj-26" : [ "r22[1]", "live.numbox", 0 ],
			"obj-28::obj-27" : [ "r21[1]", "live.numbox", 0 ],
			"obj-28::obj-28" : [ "r20[1]", "live.numbox", 0 ],
			"obj-28::obj-5" : [ "r00[1]", "live.numbox", 0 ],
			"obj-28::obj-54" : [ "width[1]", "Width", 0 ],
			"obj-28::obj-7" : [ "kernel[1]", "kernel", 0 ],
			"obj-29::obj-20" : [ "luma_invert[2]", "live.text", 0 ],
			"obj-29::obj-21" : [ "luma_smth[2]", "Smooth", 0 ],
			"obj-29::obj-3" : [ "luma_thrshld[2]", "Threshold", 0 ],
