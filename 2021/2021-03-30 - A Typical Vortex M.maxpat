...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 680.0, 818.5, 85.0, 22.0 ],
					"text" : "prepend zoom"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 478.5, 739.0, 143.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 478.5, 822.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 265.0, 794.0, 139.0, 71.0 ],
					"varname" : "vs_luma_key",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 615.0, 612.0, 215.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 505.0, 487.0, 215.0, 98.0 ],
					"varname" : "vs_convolve",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 265.0, 647.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 265.0, 491.0, 121.06883773913043, 72.5 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 481.0, 353.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 264.0, 240.5, 143.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 418.0, 240.5, 75.0, 73.5 ],
					"varname" : "vs_lfo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 264.0, 340.0, 178.0, 132.0 ],
					"varname" : "vs_wfg_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 457.0, 959.0, 164.0, 17.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 108.0, 174.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 207.0, 72.0, 22.0 ],
					"text" : "prepend fps"
				}
...
, 			{
				"box" : 				{
					"autorestore" : "2021-03-30 - A Typical Vortex M.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 265.0, 959.0, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-12::obj-22::obj-29" : [ "live.numbox[4]", "live.numbox", 0 ],
			...
			"obj-14::obj-15" : [ "live.menu[37]", "live.menu", 0 ],
			"obj-14::obj-23" : [ "live.menu[35]", "live.menu", 0 ],
			"obj-14::obj-27" : [ "hslm_sm", "SM", 0 ],
			"obj-14::obj-28" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-14::obj-33" : [ "live.menu[36]", "live.menu", 0 ],
			...
			"obj-16::obj-19" : [ "r01", "live.numbox", 0 ],
			"obj-16::obj-22" : [ "r02", "live.numbox", 0 ],
			"obj-16::obj-23" : [ "r12", "live.numbox", 0 ],
			"obj-16::obj-24" : [ "r11", "live.numbox", 0 ],
			"obj-16::obj-25" : [ "r10", "live.numbox", 0 ],
			"obj-16::obj-26" : [ "r22", "live.numbox", 0 ],
			"obj-16::obj-27" : [ "r21", "live.numbox", 0 ],
			"obj-16::obj-28" : [ "r20", "live.numbox", 0 ],
			"obj-16::obj-5" : [ "r00", "live.numbox", 0 ],
			"obj-16::obj-54" : [ "width", "Width", 0 ],
			"obj-16::obj-7" : [ "kernel", "kernel", 0 ],
			...
			"obj-8::obj-10" : [ "fd_mix", "Mix", 0 ],
			"obj-8::obj-15" : [ "live.menu[1]", "Feedback", 0 ],
			"obj-8::obj-24" : [ "fd_time", "D_Time", 0 ],
			"obj-8::obj-35" : [ "fs_playback", "vs_delay_playback", 0 ],
			"parameterbanks" : 			{
...
, 			{
				"name" : "2021-03-30 - A Typical Vortex M.json",
