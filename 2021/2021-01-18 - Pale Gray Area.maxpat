...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 620.0, 622.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 683.0, 622.0, 72.0, 22.0 ],
					"text" : "prepend fps"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 115.5, 985.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 115.5, 896.0, 46.0, 59.0 ],
					"varname" : "vs_inverter",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 143.0, 1084.0, 164.0, 17.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 116.0, 813.0, 139.0, 71.0 ],
					"varname" : "vs_luma_key",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 752.0, 292.0, 62.0, 38.0 ],
					"varname" : "vs_fish_eye[3]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 791.0, 155.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 344.0, 813.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 344.0, 903.0, 148.0, 71.0 ],
					"varname" : "vs_edges",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 445.0, 144.0, 277.0, 100.0 ],
					"varname" : "vs_wfg_2[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 344.0, 677.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 121.0, 660.0, 115.0, 94.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 394.0, 427.0, 62.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 374.0, 633.0, 62.0, 38.0 ],
					"varname" : "vs_fish_eye[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 121.0, 87.0, 62.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 394.0, 494.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 205.0, 423.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 121.0, 525.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 205.0, 368.0, 62.0, 40.0 ],
					"varname" : "vs_noise_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 215.5, 87.0, 41.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 121.0, 259.0, 79.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 121.0, 359.0, 62.0, 38.0 ],
					"varname" : "vs_fish_eye",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"autorestore" : "2021-01-18 - Pale Gray Area.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 782.0, 563.5, 135.0, 22.0 ],
					"priority" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 799.0, 563.5, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 782.0, 443.0, 171.0, 115.0 ],
					"varname" : "vs_presets",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 121.0, 134.0, 277.0, 100.0 ],
					"varname" : "vs_wfg_2[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 683.0, 443.0, 95.0, 142.5 ],
					"varname" : "vs_render",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 115.5, 1116.0, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 17.0, 17.0, 79.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-12::obj-2" : [ "noise2_dim_x", "dim_x", 0 ],
			"obj-12::obj-7" : [ "noise2_interp", "filter", 0 ],
			...
			"obj-15::obj-22::obj-52" : [ "MENU[5]", "angle", 0 ],
			"obj-15::obj-22::obj-55" : [ "MENU[6]", "angle", 0 ],
			"obj-15::obj-22::obj-56" : [ "MENU[8]", "angle", 0 ],
			"obj-15::obj-22::obj-57" : [ "MENU[7]", "angle", 0 ],
			...
			"obj-16::obj-11" : [ "pixelador_dim[1]", "pixelador_dim", 0 ],
			"obj-17::obj-11" : [ "pixelador_dim[2]", "pixelador_dim", 0 ],
			"obj-18::obj-2" : [ "noise2_dim_x[1]", "dim_x", 0 ],
			"obj-18::obj-7" : [ "noise2_interp[1]", "filter", 0 ],
			...
			"obj-20::obj-22::obj-56" : [ "MENU[10]", "angle", 0 ],
			"obj-20::obj-22::obj-57" : [ "MENU[9]", "angle", 0 ],
			...
			"obj-21::obj-28" : [ "live.toggle[5]", "live.toggle[1]", 0 ],
			"obj-21::obj-6" : [ "live.toggle[1]", "live.toggle[1]", 0 ],
			"obj-22::obj-29" : [ "edges_thrshld", "Threshold", 0 ],
			"obj-22::obj-3" : [ "edges_mode", "live.text", 0 ],
			"obj-22::obj-30" : [ "edges_smth", "Smooth", 0 ],
			"obj-22::obj-51" : [ "edges_freq", "Cutoff", 0 ],
			"obj-23::obj-43" : [ "temp_freq[2]", "Cutoff", 0 ],
			...
			"obj-2::obj-11" : [ "pixelador_dim", "pixelador_dim", 0 ],
			...
			"obj-5::obj-43" : [ "temp_freq", "Cutoff", 0 ],
...
, 			{
				"name" : "2021-01-18 - Pale Gray Area.json",
