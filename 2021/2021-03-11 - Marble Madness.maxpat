...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 143.0, 1016.0, 164.0, 17.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.0, 793.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 206.0, 891.0, 115.0, 94.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 31.0, 652.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 418.0, 103.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 664.0, 427.0, 143.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 664.0, 335.0, 75.0, 73.5 ],
					"varname" : "vs_lfo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 457.0, 644.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 207.0, 457.0, 121.06883773913043, 72.5 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 457.0, 732.0, 143.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 207.0, 272.0, 321.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 457.0, 512.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 206.0, 536.0, 139.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 206.0, 410.0, 62.0, 38.0 ],
					"varname" : "vs_fish_eye",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"autorestore" : "2021-03-11 - Marble Madness.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 338.0, 1016.0, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-12::obj-10" : [ "fd_mix[1]", "Mix", 0 ],
			"obj-12::obj-15" : [ "fd_fdbck[1]", "Feedback", 0 ],
			"obj-12::obj-24" : [ "fd_time[1]", "D_Time", 0 ],
			"obj-12::obj-35" : [ "fs_playback[1]", "vs_delay_playback", 0 ],
			"obj-13::obj-13" : [ "shapewfg_dir[1]", "inevrt", 0 ],
			"obj-13::obj-130" : [ "shapewfg_time[1]", "Time", 0 ],
			"obj-13::obj-137" : [ "shapewfg_shape[1]", "shape", 0 ],
			"obj-13::obj-26" : [ "r22", "PWM", 0 ],
			"obj-13::obj-27" : [ "r21", "PW", 0 ],
			"obj-13::obj-30" : [ "shapewfg_fm[1]", "PM", 0 ],
			...
			"obj-13::obj-45" : [ "shapewfg_polygons[1]", "Vertex", 0 ],
			...
			"obj-15::obj-33" : [ "live.menu[17]", "live.text", 0 ],
			...
			"obj-16::obj-27" : [ "r21[1]", "live.menu", 0 ],
			"obj-16::obj-94" : [ "bm_ch1", "In 1", 0 ],
			"obj-16::obj-98" : [ "bm_ch2", "In 2", 0 ],
			"obj-17::obj-15" : [ "live.menu[20]", "live.menu", 0 ],
			"obj-17::obj-23" : [ "live.menu[22]", "live.menu", 0 ],
			"obj-17::obj-27" : [ "hslm_sm[1]", "SM", 0 ],
			"obj-17::obj-28" : [ "live.menu[23]", "live.menu", 0 ],
			"obj-17::obj-33" : [ "live.menu[21]", "live.menu", 0 ],
			"obj-17::obj-39" : [ "hslm_hm[1]", "HM", 0 ],
			"obj-17::obj-46" : [ "hslm_hue[1]", "Hue", 0 ],
			"obj-17::obj-47" : [ "hslm_lm[1]", "LM", 0 ],
			"obj-17::obj-48" : [ "hslm_sat[1]", "Sat", 0 ],
			"obj-17::obj-49" : [ "hslm_light[1]", "Light", 0 ],
			"obj-17::obj-53" : [ "wfg3_speed[1]", "Pedestal", 0 ],
			...
			"obj-5::obj-10" : [ "fd_mix", "Mix", 0 ],
			"obj-5::obj-15" : [ "fd_fdbck", "Feedback", 0 ],
			"obj-5::obj-24" : [ "fd_time", "D_Time", 0 ],
			"obj-5::obj-35" : [ "fs_playback", "vs_delay_playback", 0 ],
			"obj-6::obj-1" : [ "toggle[1]", "toggle[1]", 0 ],
			"obj-6::obj-10" : [ "toggle[3]", "toggle[2]", 0 ],
			"obj-7::obj-31" : [ "clrizer_hue[3]", "Hue", 0 ],
			"obj-7::obj-60" : [ "clrizer_color[3]", "color", 0 ],
			"obj-8::obj-15" : [ "live.menu[1]", "live.menu", 0 ],
			"obj-8::obj-23" : [ "live.menu[19]", "live.menu", 0 ],
			"obj-8::obj-27" : [ "hslm_sm", "SM", 0 ],
			"obj-8::obj-28" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-8::obj-33" : [ "live.menu[18]", "live.menu", 0 ],
			...
			"obj-9::obj-4" : [ "wfg3_fm", "live.text", 0 ],
			"obj-9::obj-53" : [ "wfg3_speed", "Freq", 0 ],
...
, 			{
				"name" : "2021-03-11 - Marble Madness.json",
